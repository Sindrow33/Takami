...
class HttpPageFetcher(
    ...
    override suspend fun download(
         ...
         */
        /*
         * Незавершённая закачка идёт в подкаталог, а не рядом с целевым
         * файлом. Каталог загрузок взят дисковым кешем читалки под общий
         * лимит, а тот считает и вытесняет файлы верхнего уровня: .part
