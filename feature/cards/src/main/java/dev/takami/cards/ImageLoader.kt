...
/**
 * Загрузка картинок карточек: обложки тайтлов и портреты персонажей.
 *
 * Копия загрузчика из `:feature:swipes`, а не общий модуль: выносить сотню
 * строк в отдельный `:core:image` ради двух потребителей дороже, чем держать
 * две копии. Появится третий — вынести.
 *
